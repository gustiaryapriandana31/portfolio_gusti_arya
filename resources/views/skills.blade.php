...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid" id="skills">
            <h1>My Skills on Language Programming</h1>
            <hr>
            <div class="row">
                <div class="col-md-1 offset-md-2 me-2">
                    <i class="fab fa-html5"></i>
                    <p class="ms-3 mt-3">HTML</p>
                </div>
                <div class="col-md-1 me-3">
                    <i class="fab fa-css3-alt"></i>
                    <p class="ms-3 mt-3">CSS</p>
                </div>
                <div class="col-md-1 me-3">
                    <i class="fab fa-js"></i>
                ...
                <div class="col-md-1 me-4">
                    ...
                    <p class="ms-4 mt-3">PHP</p>
                </div>
                <div class="col-md-1 me-5">
                    <i class="fab fa-laravel"></i>
                    <p class="ms-4 mt-3">LARAVEL</p>
                </div>
                <div class="col-md-1 me-2">
                    <i class="fab fa-java"></i>
                    <p class="ms-3 mt-3">JAVA</p>
                </div>
                <div class="col-md-1">
                    <i class="fab fa-python"></i>
                    <p class="ms-2 mt-3">PYTHON</p>
                </div>
            </div>
        </div>
